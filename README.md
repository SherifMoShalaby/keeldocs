...
`0.3.0`, Apache-2.0. Covered by 174 unit tests, 39 byte-compared extractor goldens and 82 end-to-end harness checks, with double-run determinism gates on Linux and macOS. Windows runs the same matrix and reports rather than gates.
