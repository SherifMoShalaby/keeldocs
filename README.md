...
`0.4.2`, Apache-2.0. Covered by 201 unit tests, 40 byte-compared extractor goldens and 98 end-to-end harness checks, with double-run determinism gates on Linux and macOS. Windows runs the same matrix and reports rather than gates.
